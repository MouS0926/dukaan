...
<Searchbar>
  ...
  <g clip-path="url(#clip0_84664_6198)">
...
<Headerthirddiv>
    <div className="icondiv">
        ...
        <div className="icon">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" x="25%" y="25%">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
  <g clip-path="url(#clip0_84664_6209)">
    <circle cx="20" cy="20" r="20" fill="#E6E6E6"/>
